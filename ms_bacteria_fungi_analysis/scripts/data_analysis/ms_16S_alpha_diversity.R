...
range(depth) # rarefy to 2698 reads per sample
...
#ggsave("ms_bacteria_fungi_analysis/figures/alpha_diversity/stool_16S_alphadiv.pdf", device = "pdf", dpi = 300, width = 9.4, height = 3)
